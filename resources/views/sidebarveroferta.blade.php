<div id="sideBar" class="col-2 pb-0 inicio espacio ">
        <h3 class="text-center"><a  href="{{URL::previous()}}"><span
                    class="misiconos glyphicon glyphicon-repeat  text-light"></span><br></a><span class="d-block">Volver
</span>
                    </h3>
        ...
        <h3 class="text-center"><a href="/empresa/{{ Auth::id() }}/published"><span
                    class="misiconos glyphicon glyphicon-paperclip  text-light"></span></a>
...
class="glyphicon glyphicon-paperclip text-muted" ></span>
<span class="d-block">Gestionar Candidaturas</span>
        </h3>
        @endif
    </div>
